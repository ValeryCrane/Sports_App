...
// View for single statistic in RideCell
class RideStatisticCell: UIView {
    ...
    private func configure(shouldAddSeparator separator: Bool) {
        featureLabel.font = UIFont(name: "Jura-Regular", size: 12)
        featureLabel.textColor = Colors.gray4
        valueLabel.font = UIFont(name: "Jura-Bold", size: 20)
        unitLabel.font = UIFont(name: "Jura-Regular", size: 12)
